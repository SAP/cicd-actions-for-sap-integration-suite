...
- `cicd_developer`
- `cicd_release_manager`

To enable the workflows to validate team membership, you must create a **Fine-grained Personal Access Token** within your GitHub Organization.
...
![GIT Organization New Token 1](../img/GIT_ORG_NewToken_1.jpg)

![GIT Organization New Token 2](../img/GIT_ORG_NewToken_2.jpg)

![GIT Organization New Token 3](../img/GIT_ORG_NewToken_3.jpg)
...
![GIT Organization Token Final](../img/GIT_ORG_Token_Final.jpg)
