...
2. **Configure GitHub Environments and Variables** - Follow the setup guide in [`setup-git-env.md`](../setup/setup-git-env.md) for detailed instructions on configuring all required variables and secrets for DEV, TST, and PRD environments.
...
- For detailed setup instructions, refer to [`setup-git-env.md`](../setup/setup-git-env.md).
